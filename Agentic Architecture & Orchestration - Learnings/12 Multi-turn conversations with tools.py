...
#STEP 2 - ALLOW chat TO RECEIVE A LIST OF TOOLS. ALSO, RETURN THE FULL GENERATED 
#MESSAGE, NOT TEXT
...
#STEP 3 - ADD A text_from_message FUNTION TO EXTRACT ALL TEXT FROM TEXT BLOCKS FROM
#A MESSAGE
...
#-----------------------------------------------------------------------------
#STEP 1 - ENSURE add_user_message AND add_assistant_message CAN HANDLE MULTIPLE
#MESSAGE BLOCKS
messages = []
...
#STEP 4 - ADD SUPPORT FOR MULTIPLE TOOL CALLS IN A CONVERSATION
